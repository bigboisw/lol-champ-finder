...
LOL Champ Finder is an independently created app that returns a random champ that satisfies the selected criteria. Its purpose is to help new League of Legends players pick an ideal starter they want from the overwhelmingly large pool of 166 champs.
